...
INSERT INTO "subjects" ( "batch_number", "subject_name", "teacher_id") VALUES
(13, 'Python', 1),
(14, 'Data Science', 2),
(15, 'Machine Learning', 3),
(16, 'Web Development', 4),
(17, 'Database Management', 5);

-- Insert into assignments
INSERT INTO "assignments" ("subject_id", "assignment_topic", "total_score") VALUES 
(1, 'Python Basics', 100),
(2, 'Introduction to Data Science', 100),
(3, 'Linear Regression Project', 100),
(4, 'Build a Portfolio Website', 100),
(5, 'SQL Queries Practice', 100);
